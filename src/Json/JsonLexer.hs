...
jsonlexer :: String -> Either (Int, Int) [JsonToken]
jsonlexer = jsonlexer_this . addLoc 1 1 where
    ...
    jsonlexer_this :: [((Int, Int), Char)] -> Either (Int, Int) [JsonToken]
    ...
    jsonlexer_this str0 = do
        ...
        tokens1 <- case piece of
            ((1, this), ((row1, col1), (row2, col2))) -> return_one (T_lbrace)
            ((2, this), ((row1, col1), (row2, col2))) -> return_one (T_rbrace)
            ((3, this), ((row1, col1), (row2, col2))) -> return_one (T_lbracket)
            ((4, this), ((row1, col1), (row2, col2))) -> return_one (T_rbracket)
            ((5, this), ((row1, col1), (row2, col2))) -> return_one (T_comma)
            ((6, this), ((row1, col1), (row2, col2))) -> return_one (T_semicolon)
            ((7, this), ((row1, col1), (row2, col2))) -> return_one (T_true)
            ((8, this), ((row1, col1), (row2, col2))) -> return_one (T_false)
            ((9, this), ((row1, col1), (row2, col2))) -> return_one (T_null)
            ((10, this), ((row1, col1), (row2, col2))) -> return_one (T_string (read this))
            ((11, this), ((row1, col1), (row2, col2))) -> return_one (T_integer (read this))
            ((12, this), ((row1, col1), (row2, col2))) -> return_one (T_fraction (read this))
            ((13, this), ((row1, col1), (row2, col2))) -> return_one (T_exponent (read this))
